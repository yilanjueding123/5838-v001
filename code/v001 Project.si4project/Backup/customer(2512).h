...
// GPIO
    ...
    #define	VIDEO_KEY						IO_F15//IO_A1//IO_C13//IO_B5
	#define	CAPTURE_KEY						IO_F15//IO_D11//IO_C14//IO_B4
	#define FD_HD_PIN                       IO_F15

    #define SWITCH_KEY                  IO_F15
	#define VIDEO_KEY_ACTIVE               0
	#define CAPTURE_KEY_ACTIVE             0
    ...
    #define PRODUCT_NUM                     5838
	#define PRODUCT_DATA                    20170925
